...
![](visualizations/launchplot_HRrange_OhtaniHR.html){width="900" height="700"}
:::
:::::
...
Two of the balls *not* hit for a home run occurred in Game 5, where the Padres lost 2-0. Each of those balls came up just short of clearing the wall for a home run. @cr-launchplot_hr_MachadoNotHR2

::: {#cr-launchplot_hr_range_Machado}
![](visualizations/launchplot_hrRange_Machado.html){width="900" height="700"}
:::

::: {#cr-launchplot_hr_MachadoNotHR2}
![](visualizations/launchplot_HRrange_Machado_NotHR2.html){width="900" height="700"}
:::
:::::
